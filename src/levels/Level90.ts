...
const s15b = t.lastCenter(); const h15b = t.lastHeading(); const y15b = t.lastSurfaceY();
t.straight(10);
...
const level: LevelData = {
  ...
  obstacles: [
    ...
    { position: [s15[0], 0.75, s15[2] + 1], size: [1.2, 1, 1.2], breakable: true, powerUp: PowerUpType.TimeFreeze },
    { position: [s15b[0], 0.75, s15b[2] - 1], size: [1.2, 1, 1.2], breakable: true, powerUp: PowerUpType.SpeedBoost },
  ],
  latticeWalls: [
    ...
    { position: [s8b[0], y8b, s8b[2]], width: 6, height: 2, rotation: h8b, gapSide: "right", gapWidth: 1.5 },
    ...
    { position: [s15b[0], y15b, s15b[2]], width: 6, height: 2, rotation: h15b, gapSide: "left", gapWidth: 1.5 },
  ],
  windZones: [
    {
  ...
  timedGates: [
    { position: [s6b[0], 1.5, s6b[2]], size: [0.5, 2.5, 6], onTime: 1.5, offTime: 1.5 },
    { position: [s13b[0], 1.5, s13b[2]], size: [6, 2.5, 0.5], onTime: 2.0, offTime: 1.5 },
    { position: [s15b[0], 1.5, s15b[2]], size: [0.5, 2.5, 6], onTime: 1.5, offTime: 2.0 },
  ],
};
