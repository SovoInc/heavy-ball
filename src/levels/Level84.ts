...
const level: LevelData = {
  ...
  obstacles: [
    ...
    { position: [s13b[0] + 1, 0.75, s13b[2]], size: [1.2, 1, 1.2], breakable: true, powerUp: PowerUpType.Shield },
    { position: [s13c[0] - 1, 0.75, s13c[2]], size: [1.2, 1, 1.2], breakable: true, powerUp: PowerUpType.TimeFreeze },
  ],
  latticeWalls: [
